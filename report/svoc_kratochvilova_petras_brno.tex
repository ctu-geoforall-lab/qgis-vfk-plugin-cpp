...
colorlinks=true,
%pdfborder={0 0 0 0},
pdftitle={SVOČ -- Kratochvílová, Petráš},
pdfsubject={Zásuvný modul QGISu pro práci s~daty KN},
pdfauthor={Anna Kratochvílová a Václav Petráš},
pdfkeywords={QGIS} {OGR} {VFK} {NVF} {katastr} {ČÚZK} {C++} {zásuvný modul},
linkcolor=blue,
citecolor=blue,
filecolor=blue,
urlcolor=blue,
...
%opening
%\title{Zásuvný modul QGISu pro práci s~katastrálními daty}
...
Aktuánlní informace lze získat na webové stránce:
